...
examples:
	...
	CGO_ENABLED=0 GOOS=linux go build -o ./examples/upload_async/upload_async.out ./examples/upload_async/upload_async.go
	...
	CGO_ENABLED=0 GOOS=linux go build -o ./examples/create_ticket/create_ticket.out ./examples/create_ticket/create_ticket.go
